#############################################################################
# Makefile for building: SailSoma
# Generated by qmake (3.0) (Qt 5.1.0) on: sab set 28 19:59:23 2013
# Project:  SailSoma.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake QMAKE_CFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_CFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_CXXFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_CXXFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_STRIP=: PREFIX=/usr -spec linux-g++-32 CONFIG+=declarative_debug CONFIG+=qml_debug -after OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o Makefile SailSoma.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DDEPLOYMENT_PATH="\""/usr/share/SailSoma/"\"" -DHAS_BOOSTER -DQT_QML_DEBUG -DQT_DECLARATIVE_DEBUG -DQT_QUICK_LIB -DQT_QML_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-32 -I. -Isailfishapplication -I/usr/include/mdeclarativecache5 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -Imoc
LINK          = g++
LFLAGS        = -m32
...
Makefile: SailSoma.pro /usr/share/qt5/mkspecs/linux-g++-32/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) QMAKE_CFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_CFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_CXXFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_CXXFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=core2\ -mssse3\ \ -mtune=atom\ -mfpmath=sse\ -fasynchronous-unwind-tables\ -fno-omit-frame-pointer QMAKE_STRIP=: PREFIX=/usr -spec linux-g++-32 CONFIG+=declarative_debug CONFIG+=qml_debug -after OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o Makefile SailSoma.pro
...
dist: 
	@test -d obj/SailSoma1.0.0 || mkdir -p obj/SailSoma1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/SailSoma1.0.0/ && $(COPY_FILE) --parents sailfishapplication/sailfishapplication.h obj/SailSoma1.0.0/ && $(COPY_FILE) --parents main.cpp sailfishapplication/sailfishapplication.cpp obj/SailSoma1.0.0/ && (cd `dirname obj/SailSoma1.0.0` && $(TAR) SailSoma1.0.0.tar SailSoma1.0.0 && $(COMPRESS) SailSoma1.0.0.tar) && $(MOVE) `dirname obj/SailSoma1.0.0`/SailSoma1.0.0.tar.gz . && $(DEL_FILE) -r obj/SailSoma1.0.0
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/SailSoma || mkdir -p $(INSTALL_ROOT)/usr/share/SailSoma
	-$(INSTALL_PROGRAM) /home/mersdk/Documents/sviluppo/sailfish/SailSoma/main.qml $(INSTALL_ROOT)/usr/share/SailSoma/
	-$(INSTALL_DIR) /home/mersdk/Documents/sviluppo/sailfish/SailSoma/pages $(INSTALL_ROOT)/usr/share/SailSoma/
	-$(INSTALL_DIR) /home/mersdk/Documents/sviluppo/sailfish/SailSoma/cover $(INSTALL_ROOT)/usr/share/SailSoma/
	-$(INSTALL_PROGRAM) /home/mersdk/Documents/sviluppo/sailfish/SailSoma/main.qml $(INSTALL_ROOT)/usr/share/SailSoma/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SailSoma/main.qml
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SailSoma/cover
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SailSoma/pages
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SailSoma/main.qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/SailSoma/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/Documents/sviluppo/sailfish/SailSoma/SailSoma.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/SailSoma.desktop
